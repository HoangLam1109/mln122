...
export default function CorporateMap({ onAskGemini }: CorporateMapProps) {
  const [data, setData] = useState<CorporateDataMap | null>(null);
  ...
  if (loading || !data) {
    return (
      <div className="flex flex-col items-center justify-center p-12 bg-white rounded-2xl border border-zinc-200 min-h-[400px] shadow-xs">
        <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-coral border-r-2 border-honey"></div>
        <p className="mt-4 text-sm text-zinc-600 font-mono">Đang tải dữ liệu mạng lưới sở hữu tập trung...</p>
      </div>
    );
  }
  ...
  // Common institutional giants we want to highlight
  ...
  return (
    <div id="corporate-map-section" className="bg-white rounded-2xl border border-zinc-200/80 p-6 md:p-8 space-y-8 shadow-xs">
      {/* Header and industry navigation */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left and Right Company Profiles & Core Stats */}
        ...
        {/* Right SVG Ownership Network Graph */}
        <div className="lg:col-span-7 bg-ivory-dark/20 rounded-2xl p-4 md:p-6 border border-zinc-200 relative min-h-[420px] flex flex-col justify-between overflow-hidden">
          ...
          <div className="flex-1 flex items-center justify-center py-6">
            <svg viewBox="0 0 600 360" className="w-full max-w-[500px] h-auto overflow-visible select-none">
              {/* Definitions for arrow markers and gradient paths */}
              <defs>
              ...
              {/* Institutional Giants -> Company A */}
              {/* Vanguard -> Company A */}
              <path
                d="M 120 100 Q 150 180 200 240"
                fill="none"
                stroke={activeShareholder === "The Vanguard Group" ? "#E5A93C" : "#CBD5E1"}
                strokeWidth={activeShareholder === "The Vanguard Group" ? "3" : "1"}
                strokeDasharray={activeShareholder === "The Vanguard Group" ? "none" : "3,3"}
              ...
              {/* BlackRock -> Company A */}
              <path
                d="M 300 100 Q 250 180 200 240"
                fill="none"
                stroke={activeShareholder === "BlackRock, Inc." ? "#F05A4F" : "#CBD5E1"}
                strokeWidth={activeShareholder === "BlackRock, Inc." ? "3" : "1"}
                strokeDasharray={activeShareholder === "BlackRock, Inc." ? "none" : "3,3"}
                className="transition-all duration-300"
              />
              ...
              {/* State Street -> Company A */}
              <path
                d="M 480 100 Q 350 180 200 240"
                fill="none"
                stroke={activeShareholder === "State Street Corporation" ? "#1D8A82" : "#CBD5E1"}
                strokeWidth={activeShareholder === "State Street Corporation" ? "3" : "1"}
                strokeDasharray={activeShareholder === "State Street Corporation" ? "none" : "3,3"}
                className="transition-all duration-300"
              />
              ...
              {/* State Street -> Company B */}
              <path
                d="M 480 100 Q 450 180 400 240"
                fill="none"
                stroke={activeShareholder === "State Street Corporation" ? "#1D8A82" : "#CBD5E1"}
                strokeWidth={activeShareholder === "State Street Corporation" ? "3" : "1"}
                strokeDasharray={activeShareholder === "State Street Corporation" ? "none" : "3,3"}
              ...
              {/* Top Nodes: Institutional Giants */}
              {/* Vanguard */}
              <g 
                className="cursor-pointer group" 
                onMouseEnter={() => setActiveShareholder("The Vanguard Group")}
                onMouseLeave={() => setActiveShareholder(null)}
              >
              ...
              <g 
                className="cursor-pointer group"
                onMouseEnter={() => setActiveShareholder("BlackRock, Inc.")}
                onMouseLeave={() => setActiveShareholder(null)}
              >
              ...
              <g 
                className="cursor-pointer group"
                onMouseEnter={() => setActiveShareholder("State Street Corporation")}
                onMouseLeave={() => setActiveShareholder(null)}
              >
              ...
              {/* Bottom Nodes: Competitor Corporations */}
              {/* Corporation A */}
              <g className="group">
          ...
          {/* Institutional block explanation bottom */}
